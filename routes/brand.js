...
var ChildrenToyModel = require('../models/ChildrenToyModel');
...
router.get('/detail/:id', async (req, res) => {
   ...
   var ChildrenToy = await ChildrenToyModel.find({ brand : id }).populate('brand');
   res.render('brand/detail', { ChildrenToy })
})
